...
from scene.dataset import FourDGSdataset, VideoCamera, GroundTruth
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        self.video_camera = VideoCamera(scene_info.video_cameras)
        #self.video_camera = GroundTruth(scene_info.video_cameras, args, dataset_type)
