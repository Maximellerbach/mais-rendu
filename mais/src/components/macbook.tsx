...
import DaleImg from "../assets/player.png";
...
export const MacbookScroll = ({
    ...
    return (
        ...
        >
            ...
            />
            {/* Base area */}
            <div className="h-[22rem] w-[32rem] OLDbg-[#272729] bg-gray-200 rounded-2xl overflow-hidden relative -z-10">
                {/* above keyboard bar */}
